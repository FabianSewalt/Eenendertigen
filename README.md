...
Hoog `CACHE` in `sw.js` op (`31en-v1.0.1`) en `VERSION` in `app.js`. De
...
stopt, en of passen zonder kloppen is toegestaan (standaard uit — niks doen
is kloppen).
