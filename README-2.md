...
Hoog `CACHE` in `sw.js` op (`31en-v1.2.1`) en `VERSION` in `app.js`. De
...
Bij 31 stopt de ronde meteen, maar standaard verliest nog steeds alleen de
laagste hand een leven. Wil je dat de hele rest betaalt, zet dat dan om bij
de huisregels.

Een potje is afgelopen als er één speler overblijft. Je gaat dan terug naar
de lobby: de kamercode blijft geldig, de host kan de instellingen aanpassen
en meteen een nieuw potje starten. De kamer sluit pas als de host hem
verlaat.
